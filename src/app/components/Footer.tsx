      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div>
            ...
            <p
              className="text-[#C9A84C] text-xs mt-4 font-light tracking-wider"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              {t("footer.coverage")}
            </p>
          ...
          <div className="flex flex-col gap-4 md:items-center">
            {navLinks.map((link) => (
              <Link
                key={link.to}
                to={link.to}
                className="text-[#F5F5F0]/60 text-sm tracking-wider uppercase hover:text-[#C9A84C] transition-colors duration-300"
            ...
            <div className="flex gap-4 md:justify-end">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 border border-white/15 flex items-center justify-center text-[#F5F5F0]/50 hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all duration-300"
                >
                  <Icon size={15} />
                </a>
              ))}
        ...
        <div className="py-6 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p
            className="text-[#F5F5F0]/30 text-xs tracking-wider"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            {t("footer.rights")}
          </p>
          <div className="flex gap-4">
            <Link
              to="/privacy-policy"
              className="text-[#F5F5F0]/30 hover:text-[#C9A84C] text-xs tracking-wider transition-colors duration-300"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              {t("footer.privacy")}
            </Link>
            <span className="text-[#F5F5F0]/10 text-xs">•</span>
            <Link
              to="/terms-of-use"
              className="text-[#F5F5F0]/30 hover:text-[#C9A84C] text-xs tracking-wider transition-colors duration-300"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
