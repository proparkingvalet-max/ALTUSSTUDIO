            ...
            {formState === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button
                  ...
                  className="group flex items-center gap-3 px-10 py-5 bg-[#C9A84C] text-[#0A0F1E] text-sm tracking-wider uppercase hover:bg-[#D4B76A] disabled:opacity-70 transition-all duration-300"
